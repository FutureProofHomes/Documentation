Set up helpful [blueprint automations](https://www.home-assistant.io/docs/automation/using_blueprints/) within Home Assistant to get the most out of your Sat1 voice assistant and multi-sensor. 
